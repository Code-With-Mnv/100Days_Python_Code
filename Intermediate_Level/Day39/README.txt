...
We are gonna use all our knowledge of APIs, OOPs, List and Dict to make a CHEAP FLIGHT FINDER

Later we will also turn it to a full fledged product where users can sign up

required apis

Google Sheet Data Management - https://sheety.co/ (TOKEN: SHEETYISSHITTY)

Amadeus Flight Search API (Free Signup, Credit Card not required) - https://developers.amadeus.com/
API KEY: snKfggTLuCb7Dub7REy7Vqaax36KV2Sh
API SECRET: znpne3qhOwkuKD9f
